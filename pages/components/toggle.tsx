    ...
    <>
      ...
      >
        ...
        <Block variant="section" className="my-xl">
          <InfoBox>
            ...
            <ul>
              ...
              <li>{t('toggle_page.accessibility_list.point_3')}</li>
              <li>{t('toggle_page.accessibility_list.point_4')}</li>
              <li>{t('toggle_page.accessibility_list.point_5')}</li>
              <li>{t('toggle_page.accessibility_list.point_6')}</li>
              <li>{t('toggle_page.accessibility_list.point_7')}</li>
            </ul>
          </InfoBox>
        </Block>
        <Block variant="section">
          ...
          <Paragraph className="my-xl">
            {t('toggle_page.what_does_the_component_contain.text_2')}
          </Paragraph>
        </Block>
        ...
        <Block variant="section">
          <Heading variant="h2" className="mb-xl">
            {t('toggle_page.in_ui.heading')}
          </Heading>
          <Paragraph className="my-xl">
            {t('toggle_page.in_ui.text_1')}
          </Paragraph>
        </Block>

        <Block variant="section">
          <Heading variant="h2" className="mb-xl">
            {t('toggle_page.example.regular.title')}
          </Heading>
          <Paragraph className="my-xl">
            {t('toggle_page.example.regular.description')}
          </Paragraph>

          <ComponentExample>
            <ExampleLink className="test-classname" href="#">
              {t('toggle_page.example.regular.link_text')}
            </ExampleLink>
          </ComponentExample>
        </Block>
        ...
        <Block variant="section">
          <Heading variant="h2" className="mb-xl">
            {t('toggle_page.example.external.title')}
          </Heading>
          <Paragraph className="my-xl">
            {t('toggle_page.example.external.description')}
          </Paragraph>
          ...
          <ComponentExample>
            <ExampleExternalLink
              ...
              labelNewWindow={t('toggle_page.example.external.label')}
            >
              {t('toggle_page.example.external.link_text')}
            </ExampleExternalLink>
          </ComponentExample>
        </Block>
      </SideNavLayout>
