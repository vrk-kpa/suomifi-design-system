  ...
  return (
    <>
      ...
      >
        ...
        <Block variant="section" className="my-xl">
          <InfoBox>
            ...
            <ul>
              ...
              <li>{t('singleselect_page.accessibility_list.point_5')}</li>
              <li>{t('singleselect_page.accessibility_list.point_6')}</li>
              <li>{t('singleselect_page.accessibility_list.point_7')}</li>
            </ul>
          </InfoBox>
        </Block>
        ...
        <Block variant="section">
          <Heading variant="h2" className="mb-xl">
            {t('singleselect_page.in_ui.heading')}
          </Heading>
          <Paragraph className="my-xl">
            {t('singleselect_page.in_ui.text_1')}
          </Paragraph>
        </Block>

        <Block variant="section">
          <Heading variant="h2" className="mb-xl">
            {t('singleselect_page.example.regular.title')}
          </Heading>
          <Paragraph className="my-xl">
            {t('singleselect_page.example.regular.description')}
          </Paragraph>

          <ComponentExample>
            <ExampleLink className="test-classname" href="#">
              {t('singleselect_page.example.regular.link_text')}
            </ExampleLink>
          </ComponentExample>
        </Block>
        ...
        <Block variant="section">
          <Heading variant="h2" className="mb-xl">
            {t('singleselect_page.example.external.title')}
          </Heading>
          <Paragraph className="my-xl">
            {t('singleselect_page.example.external.description')}
          </Paragraph>
          ...
          <ComponentExample>
            <ExampleExternalLink
              ...
              labelNewWindow={t('singleselect_page.example.external.label')}
            >
              {t('singleselect_page.example.external.link_text')}
            </ExampleExternalLink>
          </ComponentExample>
        </Block>
      </SideNavLayout>
